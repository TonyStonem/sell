...
import com.xjw.sell.converter.OrderMaster2OrderDTOConverter;
...
import com.xjw.sell.repository.OrderDetailRepository;
import com.xjw.sell.repository.OrderMasterRepository;
import com.xjw.sell.service.OrderService;
import com.xjw.sell.service.ProductInfoService;
import com.xjw.sell.utils.KeyUtil;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO findOne(String orderId) {
        ...
        OrderMaster orderMaster = result.get();
    ...
    public OrderDTO finish(OrderDTO orderDTO) {
        ...
        if (result == null) {
            log.error("【完结订单】更新订单失败，orderId={},orderStatus={}", orderDTO.getOrderId(), orderDTO.getOrderStatus());
            throw new SellException(ResultEnum.ORDER_UPDATE_FAIL);
        }
    ...
    public OrderDTO paid(OrderDTO orderDTO) {
        ...
        OrderMaster result = orderMasterRepository.save(orderMaster);
        if (result == null) {
            log.error("【订单支付完成】更新订单支付状态失败，orderId={},orderStatus={}", orderDTO.getOrderId(), orderDTO.getOrderStatus());
            throw new SellException(ResultEnum.ORDER_UPDATE_FAIL);
        }
